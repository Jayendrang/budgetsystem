...
<body class="w3-light-grey">
	<div id="main-page">
		...
		<div class="w3-main" style="margin-top: 70px;">
			<div class="w3-panel" style="position:relative;top:100px;left:90px;" id="contact-page">
					<div class="w3-row-padding" style="margin:0 -16px">
						<div class="w3-row-padding w3-margin-bottom">
							<div class="w3-third">
								<div><i class="fa fa-map-marker w3-xxxlarge"></i></div>
								<h4>Address</h4>
								<p>University of Central Missouri</p>
								<p>108 W South St, Warrensburg, MO 64093</p>
								<div class="w3-clear"></div>
								<br/>
							</div>
							<div class="w3-third">
								<div><i class="fa fa-envelope w3-xxxlarge"></i></div>
								<h4>Email</h4>
								<p>Jxg42630@ucmo.edu</p>
								<p>9 A.M to 6 P.M</p>
								<div class="w3-clear"></div>
								<br/>
							</div>
							<div class="w3-third">
								<div><i class="fa fa-phone-square w3-xxxlarge"></i></div>
								<h4>Phone</h4>
								<p>479.XXX.XXXX</p>
								<p>9 A.M to 6 P.M</p>
								<div class="w3-clear"></div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/scripts.js">
</script>
