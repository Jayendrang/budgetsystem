...
function showHomePage(){
	document.querySelector("#expenses-page").style.display = "none";
	document.querySelector("#about-page").style.display = "none";
	document.querySelector("#contact-page").style.display = "none";
	document.querySelector("#income-page").style.display = "none";
	document.querySelector("#schedule-page").style.display = "none";
	document.querySelector("#predictions-page").style.display = "none";
...
function showExpensesPage(){
	...
	document.querySelector("#login-page").style.display = "none";
	document.querySelector("#predictions-page").style.display = "none";
	document.querySelector("#expenses-page").style.display = "block";
...
function showIncomePage(){
	...
	document.querySelector("#login-page").style.display = "none";
	document.querySelector("#predictions-page").style.display = "none";
	document.querySelector("#income-page").style.display = "block";
...
function showSchedulingPage(){
	...
	document.querySelector("#predictions-page").style.display = "none";
	document.querySelector("#login-page").style.display = "none";
	document.querySelector("#schedule-page").style.display = "block";
}
function showPredictionsPage(){
	document.querySelector("#expenses-page").style.display = "none";
	document.querySelector("#about-page").style.display = "none";
	document.querySelector("#contact-page").style.display = "none";
	document.querySelector("#income-page").style.display = "none";
	...
	document.querySelector("#login-page").style.display = "none";
	document.querySelector("#home-page").style.display = "none";
	document.querySelector("#predictions-page").style.display = "block";
}
// Home page actions
// Get the Sidebar
...
var expense_expenseList = ["Expense Types 1","Expense Types 2","Expense Types 3","Expense Types 4","Expense Types 5"];
...
for(var expense_a=0;expense_a<expense_typeFieldsList.length;expense_a++){
	...
	for(var expense_b=0;expense_b<expense_expenseList.length;expense_b++){
		expense_select.options[expense_select.options.length] = new Option(expense_expenseList[expense_b], expense_b);
	}
}
...
function expenseAddElement(isExpenseFirstElement){
  ...
  for(var expense_d=0;expense_d<expense_expenseList.length;expense_d++){
	expense_selectVal.options[expense_selectVal.options.length] = new Option(expense_expenseList[expense_d], expense_d);
  }
...
var income_expenseList = ["Income Types 1","Income Types 2","Income Types 3","Income Types 4","Income Types 5"];
...
for(var income_a=0;income_a<income_typeFieldsList.length;income_a++){
	...
	for(var income_b=0;income_b<income_expenseList.length;income_b++){
		income_select.options[income_select.options.length] = new Option(income_expenseList[income_b], income_b);
	}
}
...
function incomeAddElement(isIncomeFirstElement){
  ...
  for(var income_d=0;income_d<income_expenseList.length;income_d++){
	income_selectVal.options[income_selectVal.options.length] = new Option(income_expenseList[income_d], income_d);
  }
